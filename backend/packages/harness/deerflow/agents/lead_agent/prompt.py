...
- Use the canonical EvaluationReport skeleton from the `technology-evaluation` skill. Structured sections must keep their required object/list shapes.
- This includes executive_summary, technology_overview, risk_register, open_questions, and adoption_plan; do not replace them with loose prose strings.
